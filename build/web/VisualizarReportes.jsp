...
<html>
    ...
    <center>
        <div>
            <div>
            <h3 style="color: white;">Visualización de Reporte de Transportistas</h3>
        </div>
        </div>
        <div class="col">
            <table id="myTable" class="table table-bordered display compact" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th style="color: white;">Productos Entregados</th>
                        <th style="color: white;">Productos Pérdidos</th>
                        <th style="color: white;">Productos Restantes</th>
                        <th style="color: white;">ID Transportista</th>
                ...
                <tbody>
                    <c:forEach var="dato" items="${datos}">
                        <tr>
                            <td>${dato.getId_reporte()}</td>
                            <td>${dato.getDescripcion()}</td>
                            <td>${dato.getProductos_entregados()}</td>
                            <td>${dato.getProductos_perdidos()}</td>
                            <td>${dato.getProductos_restantes()}</td>
