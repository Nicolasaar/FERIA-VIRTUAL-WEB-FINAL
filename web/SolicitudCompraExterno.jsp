...
<html>
    ...
    <body style="background-image:url(css/derecha.jpg);">
        <nav class="navbar navbar-expand-lg navbar-dark bg-danger">
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a style="margin-left: 10px; border: none" class="btn btn-outline-light"  href="ClienteExterno.jsp">Volver al Inicio</a>
                    </li>
    ...
    <center>
        <div>
            <h3>Realizar Solicitud de Compra Externa</h3>
        </div>
        <hr>
        <div>
            <form action="Controlador2?menu=Producto" method="POST">
                ID Solicitud:
                <br>
